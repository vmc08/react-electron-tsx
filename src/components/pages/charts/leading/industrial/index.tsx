...
const PriceRentalIndex = LoadableComponent({
  componentPathName: 'components/pages/charts/leading/industrial/components/PriceRentalIndex',
});

const VacancyRates = LoadableComponent({
  componentPathName: 'components/pages/charts/leading/industrial/components/VacancyRates',
});

const PotentialSupplyStatistics = LoadableComponent({
  componentPathName:
    'components/pages/charts/leading/industrial/components/PotentialSupplyStatistics',
});
